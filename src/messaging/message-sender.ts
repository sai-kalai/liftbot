...
import { Button, ButtonsList, ButtonTypes } from "@src/model/buttons";
...
export class MessageSender {
    ...
    sendButtonsMessage(msg: string, options: ButtonsList) {
        ...
        // FIX: This is not producing the expected behavior during testing.
        // - verify payload
        // -
        console.log(`Data payload to be sent in POST request:\n${dataPayload}`);
